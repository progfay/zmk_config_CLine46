...
uf2_file() {
  case "$1" in
    left)  echo "CLine46_L rgbled_adapter-xiao_ble__zmk-zmk.uf2" ;;
    right) echo "CLine46_R rgbled_adapter-xiao_ble__zmk-zmk.uf2" ;;
    reset) echo "settings_reset-xiao_ble__zmk-zmk.uf2" ;;
    *)     return 1 ;;
  esac
}
